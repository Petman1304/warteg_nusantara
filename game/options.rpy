...
define config.name = _("warteg_nusantara")
...
define build.name = "warteg_nusantara"
...
define config.main_menu_music = "Spring-field.mp3"
...
define config.save_directory = "warteg_nusantara-1759305710"
